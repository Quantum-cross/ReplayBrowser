...
namespace Server.Migrations
{
    ...
    [Migration("20260201233529_AddObjectives")]
            ...
            modelBuilder.Entity("ReplayBrowser.Data.Models.Account.Account", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("FavoriteReplays")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.PrimitiveCollection<List<Guid>>("SavedProfiles")
                        .IsRequired()
                        .HasColumnType("uuid[]");
            ...
            modelBuilder.Entity("ReplayBrowser.Data.Models.Player", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("AntagPrototypes")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.PrimitiveCollection<List<string>>("JobPrototypes")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("ReplayBrowser.Data.Models.Replay", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("Maps")
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("ReplayBrowser.Data.Models.Player", b =>
                {
                    ...
                    b.OwnsMany("ReplayBrowser.Data.Models.Player+Objective", "Objectives", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
